        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              I enjoy exploring new <b className="purple">AI tools</b> and
              <i>
                <b className="purple">
                  {" "}
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/hemantgupta4"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/hemant-kumar-gupta/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/hemant_gupta4?utm_source=qr&igsh=YnhpaGZ6aGNqMHl6"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
